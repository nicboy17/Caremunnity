...
module.exports = function(router) {
    ...
    router.post('/upload', upload.single('avatar'), function(req, res) {
        var file = "http://real-time-solutions.com:4000/images/"+req.file.filename;
        User.updateUserImage(req.body.user_id, file, function(err, result) {
            if(err) throw err;
            if(result.affectedRows > 0) {
                res.json({'sucess': 'true', 'url': file});
            } else {
