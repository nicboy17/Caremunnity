...
var Medication = {  
    ...
    getUserMedications: function(id, callback) {
        return db.query('select medication.medication_id, medication.dosage, medication.name from user_medication left join medication on medication.medication_id = users_table.medication_id where user_id = ?'
        ,[id], callback);  
    },
